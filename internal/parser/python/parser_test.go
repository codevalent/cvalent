...
func TestPythonParser_Fixtures(t *testing.T) {
	fixtures := []struct {
		name  string
		dir   string
		files []string
	}{
		{"basic", "../../../testdata/python/basic", []string{"input/service.py"}},
		{"inferred", "../../../testdata/python/inferred", []string{"input/utils.py"}},
		{"dataclass", "../../../testdata/python/dataclass", []string{"input/models.py"}},
		{"nullable", "../../../testdata/python/nullable", []string{"input/handlers.py"}},
		{"test_tagging", "../../../testdata/python/test_tagging", []string{"input/test_service.py"}},
		{"decorators", "../../../testdata/python/decorators", []string{"input/api.py"}},
	}
